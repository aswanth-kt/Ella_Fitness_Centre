        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://facebook.com" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-gold transition-colors p-2 glass rounded-full hover:scale-110 duration-300 flex items-center justify-center" aria-label="Facebook">
              ...
              <a href="https://youtube.com" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-gold transition-colors p-2 glass rounded-full hover:scale-110 duration-300 flex items-center justify-center" aria-label="Youtube">
